...
export const ISL_LEVELS = [
  "Raudah 1A", "Raudah 1B", "Raudah 2", "Raudah 3",
  "Pri 1A Islamiyyah", "Pri 1B Islamiyyah",
  "Pri 2 Islamiyyah",  "Pri 3 Islamiyyah",
  "Pri 4 Islamiyyah",  "Pri 5 Islamiyyah",
  "Barnamaj",
...
export const DEPTS = [
  ...
  "Diploma", "Administration", "Finance", "Non-Academic",
];
...
// Timetable for JSS1 (template — editable from Manage > Settings)
